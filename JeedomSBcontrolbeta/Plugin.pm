package Plugins::JeedomSBcontrolbeta::Plugin;
use strict;
use base qw(Slim::Plugin::Base);
use Plugins::JeedomSBcontrolbeta::Settings;
use Slim::Music::Info;
...
sub getDisplayName {
	return 'PLUGIN_JEEDOMSBCONTROLBETA_NAME';
}
...
sub initPlugin {
	...
	Plugins::JeedomSBcontrolbeta::Settings->new;
